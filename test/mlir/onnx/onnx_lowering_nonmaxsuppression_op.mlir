...
// CHECK-DAG:                 [[VAR_59_:%.+]] = arith.maximumf [[VAR_42_]], [[VAR_54_]] : f32
// CHECK-DAG:                 [[VAR_60_:%.+]] = arith.maximumf [[VAR_46_]], [[VAR_50_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_61_:%.+]] = arith.minimumf [[VAR_44_]], [[VAR_56_]] : f32
// CHECK-DAG:                 [[VAR_62_:%.+]] = arith.minimumf [[VAR_48_]], [[VAR_52_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_63_:%.+]] = arith.subf [[VAR_61_]], [[VAR_59_]] : f32
// CHECK-DAG:                 [[VAR_64_:%.+]] = arith.subf [[VAR_62_]], [[VAR_60_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_65_:%.+]] = arith.maximumf [[VAR_63_]], [[CST_0_dot_000000_]] : f32
// CHECK-DAG:                 [[VAR_66_:%.+]] = arith.maximumf [[VAR_64_]], [[CST_0_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK-DAG:                 [[VAR_48_:%.+]] = arith.maximumf [[LOAD_RES_4_MEM_1_]], [[LOAD_RES_4_MEM_5_]] : f32
// CHECK-DAG:                 [[VAR_49_:%.+]] = arith.maximumf [[LOAD_RES_4_MEM_]], [[LOAD_RES_4_MEM_4_]] : f32
// CHECK-DAG:                 [[VAR_50_:%.+]] = arith.minimumf [[LOAD_RES_4_MEM_3_]], [[LOAD_RES_4_MEM_7_]] : f32
// CHECK-DAG:                 [[VAR_51_:%.+]] = arith.minimumf [[LOAD_RES_4_MEM_2_]], [[LOAD_RES_4_MEM_6_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_52_:%.+]] = arith.subf [[VAR_50_]], [[VAR_48_]] : f32
// CHECK-DAG:                 [[VAR_53_:%.+]] = arith.subf [[VAR_51_]], [[VAR_49_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_54_:%.+]] = arith.maximumf [[VAR_52_]], [[CST_0_dot_000000_]] : f32
// CHECK-DAG:                 [[VAR_55_:%.+]] = arith.maximumf [[VAR_53_]], [[CST_0_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK-DAG:                 [[VAR_49_:%.+]] = arith.maximumf [[LOAD_RES_4_MEM_1_]], [[LOAD_RES_4_MEM_5_]] : f32
// CHECK-DAG:                 [[VAR_50_:%.+]] = arith.maximumf [[LOAD_RES_4_MEM_]], [[LOAD_RES_4_MEM_4_]] : f32
// CHECK-DAG:                 [[VAR_51_:%.+]] = arith.minimumf [[LOAD_RES_4_MEM_3_]], [[LOAD_RES_4_MEM_7_]] : f32
// CHECK-DAG:                 [[VAR_52_:%.+]] = arith.minimumf [[LOAD_RES_4_MEM_2_]], [[LOAD_RES_4_MEM_6_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_53_:%.+]] = arith.subf [[VAR_51_]], [[VAR_49_]] : f32
// CHECK-DAG:                 [[VAR_54_:%.+]] = arith.subf [[VAR_52_]], [[VAR_50_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_55_:%.+]] = arith.maximumf [[VAR_53_]], [[CST_0_dot_000000_]] : f32
// CHECK-DAG:                 [[VAR_56_:%.+]] = arith.maximumf [[VAR_54_]], [[CST_0_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK-DAG:                 [[VAR_61_:%.+]] = arith.maximumf [[VAR_44_]], [[VAR_56_]] : f32
// CHECK-DAG:                 [[VAR_62_:%.+]] = arith.maximumf [[VAR_48_]], [[VAR_52_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_63_:%.+]] = arith.minimumf [[VAR_46_]], [[VAR_58_]] : f32
// CHECK-DAG:                 [[VAR_64_:%.+]] = arith.minimumf [[VAR_50_]], [[VAR_54_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_65_:%.+]] = arith.subf [[VAR_63_]], [[VAR_61_]] : f32
// CHECK-DAG:                 [[VAR_66_:%.+]] = arith.subf [[VAR_64_]], [[VAR_62_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_67_:%.+]] = arith.maximumf [[VAR_65_]], [[CST_0_dot_000000_]] : f32
// CHECK-DAG:                 [[VAR_68_:%.+]] = arith.maximumf [[VAR_66_]], [[CST_0_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
