...
// CHECK-DAG:       [[VAR_1_:%.+]] = tosa.reshape [[PARAM_0_]] {new_shape = array<i64: 1, 128, 16, 64>} : (tensor<128x1024xf32>) -> tensor<1x128x16x64xf32>
// CHECK:           return [[VAR_1_]] : tensor<1x128x16x64xf32>
// CHECK:         }
}
...
// CHECK-DAG:       [[VAR_0_:%.+]] = "tosa.const"() <{value = dense<[-1, 0, 16, 64]> : tensor<4xi64>}> : () -> tensor<4xi64>
// CHECK-DAG:       [[VAR_1_:%.+]] = tosa.reshape [[PARAM_0_]] {new_shape = array<i64: 12, 128, 16, 64>} : (tensor<12x128x1024xf32>) -> tensor<12x128x16x64xf32>
// CHECK:           return [[VAR_1_]] : tensor<12x128x16x64xf32>
// CHECK:         }
}
