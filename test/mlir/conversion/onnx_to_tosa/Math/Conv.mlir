...
// CHECK-DAG:       [[VAR_20_:%.+]] = tosa.concat [[VAR_7_]], [[VAR_11_]], [[VAR_15_]], [[VAR_19_]] {axis = 3 : i32} : (tensor<5x17x17x3xf32>, tensor<5x17x17x3xf32>, tensor<5x17x17x3xf32>, tensor<5x17x17x3xf32>) -> tensor<5x17x17x12xf32>
